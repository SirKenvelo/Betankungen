...
- S8C1/4 - Cost-MVP-Basis gestartet: `--stats cost` als neuer Stats-Target-Pfad mit Core-Textausgabe (fuel-basiert, maintenance placeholder), inkl. Validate-/Smoke-/Doku-Sync; Artefakte: `.artifacts/sprint_8_commit_1_von_4.md`, `.artifacts/sprint_8_commit_1_von_4.diff`; Basis-Commit: `TBD`. (2026-03-11)
