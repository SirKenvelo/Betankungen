...
- S8C3/4 - Cost-Guardrails regressionsgesichert: Domain-Policy-/Smoke-Abdeckung fuer ungueltige Cost-Optionen (`--csv`, `--monthly`, `--yearly`, `--dashboard`, `--from/--to`, `--car-id`) erweitert; Artefakte: `.artifacts/sprint_8_commit_3_von_4.md`, `.artifacts/sprint_8_commit_3_von_4.diff`; Basis-Commit: `TBD`. (2026-03-11)
