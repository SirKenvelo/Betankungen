...
- S7C2/4 - Fleet-JSON-MVP fuer `--stats fleet --json [--pretty]` eingefuehrt (Core-Renderer + Validate/Dispatch), inkl. Smoke-/Policy-Checks und Doku-Sync; Artefakte: `.artifacts/sprint_7_commit_2_von_4.md`, `.artifacts/sprint_7_commit_2_von_4.diff`; Basis-Commit: `TBD`. (2026-03-10)
