...
- S6C2/4 - Minimaler Modul-Handshake eingefuehrt: neue Contract-Unit `u_module_info`, Companion-Skeleton `betankungen-maintenance` mit `--module-info` (JSON) und Core-Version auf `0.9.0-dev` synchronisiert; Artefakte: `.artifacts/sprint_6_commit_2_von_4.md`, `.artifacts/sprint_6_commit_2_von_4.diff`; Basis-Commit: `TBD`. (2026-03-10)
