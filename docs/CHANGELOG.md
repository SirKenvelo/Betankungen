...
- General-2026-04-20-governance-core-sync - `AGENTS.md` und `docs/GIT_WORKFLOW.md` auf denselben `POL-004`-Operationsstand gezogen; PR-Hinweise/Follow-ups bleiben innerhalb von `## Summary`, Merge-Commit-Messages bleiben kompakt, Tag-Messages bleiben die eigene `## Summary`/`## Validation`/`## Impact`-Domaene mit `--cleanup=verbatim`; repo-seitige Traceability in `docs/STATUS.md` und `docs/SPRINTS.md` nachgezogen. Basis-Commit: `114b32d`. (2026-04-20)
