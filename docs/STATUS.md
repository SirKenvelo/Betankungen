...
- Gate-Stand:
  ...
  - Gate 2 (S13) in Arbeit (Contract + Modulfaehigkeiten; `BL-0012` ist done, zentrale CSV-Contract-Regression ist in Verify/CI verankert, Deprecation-Status gemaess `POL-002` ist explizit dokumentiert; verbleibender Restscope: Gate-2-Abschlusslauf `S13C4/4`).
