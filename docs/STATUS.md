...
- Gate-Stand:
  ...
  - Gate 5 aktiv (Kickoff `S19C1/4` + Checklisten-/Scope-Snapshot `S19C2/4` + Release-Umschaltpaket `S19C3/4` dokumentiert; CI-Referenz auf `main`: Run `23243226276`, Commit `6088568`; Release-Freigabe ausstehend).
...
- Operativer Fokus:
  - explizite Release-Freigabe fuer `1.1.0` holen und danach Release-Umschalt-Commit + Doku-Finalsync + Release-/Backup-Ausfuehrung abschliessen (`S19C4/4`),
