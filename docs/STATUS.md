...
- Gate-Stand:
  ...
  - Gate 2 (S13) in Arbeit (Contract + Modulfaehigkeiten; `BL-0012` ist done, zentrale CSV-Contract-Regression ist in Verify/CI verankert, verbleibender Restscope: sichtbarer Deprecation-Status gemaess `POL-002`).
