...
- Gate-Stand:
  ...
  - Gate 5 aktiv (Kickoff `S19C1/4` + Checklisten-/Scope-Snapshot `S19C2/4` dokumentiert; CI-Referenz auf `main`: Run `23243226276`, Commit `6088568`; Release-Freigabe ausstehend).
...
- Operativer Fokus:
  - finalen Release-Umschalt-Commit fuer 1.1.0 vorbereiten (`APP_VERSION 1.1.0-dev -> 1.1.0`) und den Doku-Finalsync abschliessen (`S19C3/4`),
