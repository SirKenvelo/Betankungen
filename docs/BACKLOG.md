...
- [BL-0036 - Contributor Onboarding and English Entry-Layer Hardening](backlog/BL-0036-contributor-onboarding-and-english-entry-layer-hardening/item.md) - Status: `approved`, Typ: Improvement (der verbleibende Entry-Layer-Folgeblock ist jetzt in drei nicht ueberlappende Tasks fuer Contributor-Quickstart, englische Entry-Signale und README-/Wiki-/`CONTRIBUTING.md`-Handoff geschnitten), Lane: `planned`, Tasks: `TSK-0032` (`todo`), `TSK-0033` (`todo`), `TSK-0034` (`todo`)
