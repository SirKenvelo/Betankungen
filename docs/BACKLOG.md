...
- [BL-0036 - Contributor Onboarding and English Entry-Layer Hardening](backlog/BL-0036-contributor-onboarding-and-english-entry-layer-hardening/item.md) - Status: `in_progress`, Typ: Improvement (der erste Slice fuer einen kompakten Contributor-Quickstart in `CONTRIBUTING.md` ist geliefert; die verbleibende Folgearbeit bleibt auf englische Entry-Signale sowie den README-/Wiki-/`CONTRIBUTING.md`-Handoff begrenzt), Lane: `planned`, Tasks: `TSK-0032` (`done`), `TSK-0033` (`todo`), `TSK-0034` (`todo`)
