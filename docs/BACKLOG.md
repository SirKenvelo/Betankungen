...
- [BL-0018 - Historische Tankstellenpreis-Erfassung via API-Polling](backlog/BL-0018-fuel-price-history-polling/item.md) - Status: `in_progress`, Typ: Feature (15-Minuten-Polling + Historienbasis), Lane: `release-blocking` (1.3.0)
