...
- [BL-0036 - Contributor Onboarding and English Entry-Layer Hardening](backlog/BL-0036-contributor-onboarding-and-english-entry-layer-hardening/item.md) - Status: `proposed`, Typ: Improvement (gebuendelter Folgeblock fuer kompakteres Contributor-Onboarding, klarere englische Einstiegsschicht und weniger Friktion zwischen README, Wiki und `CONTRIBUTING.md`), Lane: `planned`
