...
- [BL-0033 - TUI Presentation and View-Layer Refresh](backlog/BL-0033-tui-presentation-and-view-layer-refresh/item.md) - Status: `approved`, Typ: Improvement (naechster Sprintkandidat mit festgezogenem Referenzscreen `Betankungen --list fuelups --detail`; `TSK-0029` schneidet dafuer die erste kleine View-/Painter-Basis bewusst ohne Form-System), Lane: `planned`, Tasks: `TSK-0029` (`todo`)
