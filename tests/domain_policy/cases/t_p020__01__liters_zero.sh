...
# t_p020__01__liters_zero.sh
# UPDATED: 2026-02-22
# Policy P-020: liters <= 0 fuehrt zu Hard Error ohne Write.
...
TMP_DIR="$(mktemp -d /tmp/t_p020_zero_XXXXXX)"
...
if [[ $RC -eq 0 ]]; then
  fail 'Erwartet Exitcode != 0 fuer P-020 (liters=0), erhalten: 0'
fi
...
printf '[OK] P-020/01: liters=0 fuehrt zu Hard Error ohne Insert.\n'
