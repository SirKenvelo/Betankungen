...
# UPDATED: 2026-04-07
# Policy P-050: missed_previous=1 bei kleiner Distanz ist nur ueber den expliziten Ausnahmepfad erlaubt.
...
printf '[OK] P-050/01: Confirm=YES erlaubt den expliziten Ausnahme-Reset bei kleiner Distanz.\n'
